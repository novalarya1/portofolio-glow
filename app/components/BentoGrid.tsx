...
export function BentoGrid() {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 auto-rows-[280px] max-w-7xl mx-auto p-4">
...
function ProjectCard({ project, index }: ProjectCardProps) {
  return (
    ...
    >
      ...
      {/* Action Buttons */}
      <div className="absolute top-8 right-8 flex gap-3 z-30 opacity-0 group-hover:opacity-100 translate-y-2 group-hover:translate-y-0 transition-all duration-300">
